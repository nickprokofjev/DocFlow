...
async def docflow_exception_handler(request: Request, exc: DocFlowException) -> JSONResponse:
    """
...
def get_error_response(message: str, status_code: int = 400, error_code: str = None) -> Dict[str, Any]:
    """
